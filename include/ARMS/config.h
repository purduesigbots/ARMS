...
// Odometry
#define LEFT_RIGHT_DISTANCE 5 // Distance between left and right tracking wheels
							  // This will cause divide by zero errors if 0
...
#define LINEAR_EXIT_ERROR 2  // default exit distance for linear movements
