...
/*!
	...
	* @endcode
	*
	* @details Sets the distance between the middle wheel and the center of the robot to \a dist.
 */
...
/*!
	* @brief Tracking kD
	*
	* @param trackkd the derivative constant for turning strength during point to point movements
	*
	* <b>Example 1:</b>
	* @code
	* //using a Tracking kD of 60
	* #define TRACKING_KD 60
	* @endcode
	*
	* @details sets the derivative constant for turning strength during point to point movements to \a trackkd
*/
...
/*!
	* @brief Minimum Linear Speed
	*
	* @param speed the minimum speed for linear movements
	* 
	* <b>Example 1:</b>
	* @code
	* //using a minimum linear movement speed of 10
	* #define MIN_LINEAR_SPEED 10
	* @endcode
	*
	* @details Sets the minimum speed for linear movements to \a speed.
*/
#define MIN_LINEAR_SPEED 0

/*!
	* @brief Minimum Angular Speed
	*
	* @param speed the minimum speed for angular movements
	*
	* <b>Example 1:</b>
	* @code
	* //using a minimum angular movement speed of 10
	* #define MIN_ANGULAR_SPEED 10
	* @endcode
	*
	* @details Sets the minimum speed for angular movements to \a speed.
*/
#define MIN_ANGULAR_SPEED 0
